...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_dsym "${PODS_ROOT}/FBAllocationTracker/FBAllocationTracker.framework.dSYM"
  install_framework "${PODS_ROOT}/FBMemoryProfiler/FBMemoryProfiler.framework"
  install_dsym "${PODS_ROOT}/FBMemoryProfiler/FBMemoryProfiler.framework.dSYM"
  install_framework "${PODS_ROOT}/FBRetainCycleDetector/FBRetainCycleDetector.framework"
  install_dsym "${PODS_ROOT}/FBRetainCycleDetector/FBRetainCycleDetector.framework.dSYM"
  install_framework "${PODS_ROOT}/FPSCounter/FPSCounter.framework"
  install_dsym "${PODS_ROOT}/FPSCounter/FPSCounter.framework.dSYM"
  install_framework "${PODS_ROOT}/FTLinearActivityIndicator/FTLinearActivityIndicator.framework"
  install_dsym "${PODS_ROOT}/FTLinearActivityIndicator/FTLinearActivityIndicator.framework.dSYM"
  install_framework "${PODS_ROOT}/GECoreData/GECoreData.framework"
  install_dsym "${PODS_ROOT}/GECoreData/GECoreData.framework.dSYM"
  ...
  install_dsym "${PODS_ROOT}/GEFoundation/GEFoundation.framework.dSYM"
  install_framework "${PODS_ROOT}/GETracing/GETracing.framework"
  install_dsym "${PODS_ROOT}/GETracing/GETracing.framework.dSYM"
  install_framework "${PODS_ROOT}/GEUIKit/GEUIKit.framework"
  install_dsym "${PODS_ROOT}/GEUIKit/GEUIKit.framework.dSYM"
  install_framework "${PODS_ROOT}/GoogleToolboxForMac/GoogleToolboxForMac.framework"
  install_dsym "${PODS_ROOT}/GoogleToolboxForMac/GoogleToolboxForMac.framework.dSYM"
  install_framework "${PODS_ROOT}/JGProgressHUD/JGProgressHUD.framework"
  install_dsym "${PODS_ROOT}/JGProgressHUD/JGProgressHUD.framework.dSYM"
  install_framework "${PODS_ROOT}/Loggy/Loggy.framework"
  install_dsym "${PODS_ROOT}/Loggy/Loggy.framework.dSYM"
  ...
  install_dsym "${PODS_ROOT}/PromisesSwift/Promises.framework.dSYM"
  install_framework "${PODS_ROOT}/R.swift.Library/Rswift.framework"
  install_dsym "${PODS_ROOT}/R.swift.Library/Rswift.framework.dSYM"
  ...
  install_dsym "${PODS_ROOT}/Result/Result.framework.dSYM"
  install_framework "${PODS_ROOT}/Watchdog/Watchdog.framework"
  install_dsym "${PODS_ROOT}/Watchdog/Watchdog.framework.dSYM"
fi
